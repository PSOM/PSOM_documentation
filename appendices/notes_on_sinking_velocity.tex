...
\marginnote{\justifying \small \textbf{\underline{What is the constant C?}}\\The value of $C$ is irrelevant in this context, as the difference between two z-levels is the quantity we are ultimately interested in.}
